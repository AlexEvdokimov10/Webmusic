...
export default function playerReducer(state=defaultState, action) {
    switch (action.type){
        ...
        case SET_BUFFERED: return {...state,buffered: action.payload}
        ...
        case SET_END:return {...state,isEnd: action.payload}
        default:
            return state
    }
}
...
export const setEnd=(isEnd)=>({type:SET_END,payload:isEnd})
export const setBuffered=(buffered)=>({type:SET_BUFFERED,payload:buffered})